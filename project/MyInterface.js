...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'displayBillboard').name('Billboard');
        this.gui.add(this.scene, 'displayTreePatch').name('TreePatch');
        this.gui.add(this.scene, 'displayTreeRow').name('TreeRow');
